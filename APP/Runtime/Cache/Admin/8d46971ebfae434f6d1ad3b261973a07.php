...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <link rel="stylesheet" href="__ROOT__/App/Modules/Admin/Tpl/Public/Css/login.css" />
        <meta http-equiv="Content-Type" content="text/html;charset=utf-8">
            ...
            <script type="text/javascript" src="__ROOT__/App/Modules/Admin/Tpl/Public/Js/login.js"></script>
    </head>
    <body>
        <div id="top">
